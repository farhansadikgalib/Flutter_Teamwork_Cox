...
class twentysix extends StatefulWidget {
  ...
  @override
  _twentysixState createState() => _twentysixState();
}
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Farhan sadik Galib",style: TextStyle(fontSize: 20),),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text("Md. Abdur Rahman",style: TextStyle(fontSize: 20),),
                      Text("170115",style: TextStyle(fontSize: 20),),
                      Row(
                        children: [
                          Radio(value: 1, groupValue: 1, onChanged: (value){}),
                          Text('present'),
